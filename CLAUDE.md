...
- `contract/target/scala-2.12/invaract-contract-0.9.0.jar`
...
spark-shell --jars plugin/target/scala-2.12/invaract-spark-plugin-0.2.0.jar,spark-adapter/target/scala-2.12/invaract-spark-adapter-0.7.0.jar
