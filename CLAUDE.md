...
- `spark-adapter/target/scala-2.12/invaract-spark-adapter-0.6.0.jar` — via
...
spark-shell --jars plugin/target/scala-2.12/invaract-spark-plugin-0.2.0.jar,spark-adapter/target/scala-2.12/invaract-spark-adapter-0.6.0.jar
