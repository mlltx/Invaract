...
Invaract is early-stage and hasn't published a Maven artifact yet. Today, you use it by
cloning the repository and building its modules from source, either on your own machine
or, if you'd rather not install the toolchain yourself, in GitHub Codespaces. Both paths
are covered below.
</Aside>
